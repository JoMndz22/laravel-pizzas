...
@section('body')
<div class="container-fluid container-login bg-red-pizza">
    <div class="row justify-content-center">
        <div class="col-md-8 dv-login">
            <h2 class="text-white text-center">Registrate</h2>
            <hr class="mb-5 d-inline-block w-100">

            <div class="card bg-red-pizza rounded-0 border-0">
